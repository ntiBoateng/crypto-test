    ...
    <Table className="container-fluid" style={colorStyle}>
      <Thead>
        <Tr >
          ...
          <ThPercent className={thClass} style={thStyle} pubIsOpen={props.pubIsOpen} onClick={handleClickChangeh1}>%(1hr)</ThPercent>
          <ThPercent className={thClass} style={thStyle} pubIsOpen={props.pubIsOpen} onClick={handleClickChangeh24}>%(24hr)</ThPercent>
          ...
          <ThPercent className={thClass} style={thStyle} pubIsOpen={props.pubIsOpen} onClick={handleClickChanged30}>%(1m)</ThPercent>
          ...
          <ThSupply className={thClass} style={thStyle} pubIsOpen={props.pubIsOpen} onClick={handleClickSupply}>Total Supply</ThSupply>
