...
const CoinRankingNavBar = (props) => {
  ...
  const itemEURClass = "dropdown-item" + (props.devise === "EUR" ? " active" : "");
  ...
  const toggleDeviseEUR = () => {
    props.toggleDevise("EUR");
  }
      ...
      <div className="d-flex justify-content-end filter" style={pageStyle}>
        ...
        <div className="dropdown">
          ...
          <div className={menuDeviseClass} aria-labelledby="dropdownCurButton">
            ...
            <BtnCurMenu className={itemEURClass} onClick={toggleDeviseEUR} >EUR</BtnCurMenu>
